...
function Skills(props) {
  ...
  function skillsFooter(activeWnd) {
    if (activeWnd === "MENU") {
      return <p className='slide-left'>Click on a category to see my skill profile!</p>
    } else {
      return (
        <MDBBtn size='lg' color='mdb-color' className='back-btn slide-right' onClick={backToMenu}>
          Back to Menu
        </MDBBtn>
      )
    }
  ...
  return (
    <div className='skills-page'>
      ...
      <div className='skills-footer'>{skillsFooter(activeWnd)}</div>
    </div>
  )
}
